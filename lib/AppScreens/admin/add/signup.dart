...
// and:
      ...
      onSaved: (String value) {
        ...
        _currentUser.address = 'Random Address';
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Padding(
                    ...
                    child: TextFormField(
                      initialValue: widget.isUpdating  ? _currentUser.phoneNumber.substring(3) : _currentUser.phoneNumber,
...
// and:
                      ...
                      onChanged: (val) {
                        setState(() {
                          this.phoneNo = '+91' + val;
                          _currentUser.phoneNumber = '+91' + val;
                          // userDetail.email =
                  ...
                  child: InkWell(
                    ...
                    onTap: widget.isUpdating
                        ...
                        : () {
                            ...
                            formKey.currentState.save();
                            addUserDataNew(_currentUser).then(
                              (value) {
